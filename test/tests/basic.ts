...
describe('basic type cases', () => {
    ...
    it('should serialize undefined in an object', () => {
        ...
        const result = deserialize<Record<string, unknown>>(serialize(obj));
    ...
    it('should serialize an error', () => {
        const val : ExtendedError = new Error('meep');
        val.code = 'ERROR_55';
        val.data = { zerp: 'blerp' };
        const result = deserialize<ExtendedError>(serialize(val));
